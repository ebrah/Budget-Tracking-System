			...
			<div>
         	 ...
         	 <div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"> Edit proposed Project. </h3>
									<div class="right">
                                    <?php
				...
				<div class="panel-body">
                    ...
                    <?php echo form_open_multipart(base_url()."public/index.php/Project/submit_project/edit/TRUE/id/".$project['project_id']);?>
					      <div class="row">
					       ...
					       <div class="form-group">
					          ...
					          <div class="col-sm-5">
					            <input type="text" id="inputEmail1" value="<?php echo $project['project_name']; ?>" class="form-control regform-control" name="project_title" placeholder="Title" required>
					          </div>
					        </div>
							...
							<div class="form-group">
					          ...
					          <div class="col-sm-5">
					            <input type="date" id="date1" class="form-control regform-control" value="<?php echo $project['start']; ?>" name="start_date" placeholder="start date" required>
					          </div>
					        </div>
							...
							<div class="form-group">
					          ...
					          <div class="col-sm-5">
					            <input type="date" id="date2" class="form-control regform-control" value="<?php  echo $project['end']; ?>"name="end_date" placeholder="end date" required>
					          </div>
					        </div>
					        ...
					        <div class="form-group">
					          ...
					          <div class="col-sm-5">
                               <textarea name="project_description" id="description" value="<?php echo $project['description']; ?>" placeholder="describe little about this project" class="form-control regform-control" required></textarea>
					          </div>
					        ...
					        <div class="form-group">
					          ...
					          <div class="col-sm-5">
					            <input type="file" id="inputEmail3" value="<?php echo $project['file']; ?>" class="form-control regform-control" name="userfile" >
					          </div>
					        </div>
							...
							<div class="form-group">
					          ...
					          <div class="col-sm-5">
					            <input type="text" id="client" class="form-control regform-control" value="<?php echo $project['client']; ?>" name="client_name" placeholder="Client name" required>
					          </div>
					        </div>
							...
							<div class="form-group">
					          ...
					          <div class="col-sm-5">
					            <input type="text" id="contact" class="form-control regform-control" value="<?php echo $project['contact']; ?>" name="contact" placeholder="Client Contact" required>
					          </div>
					        </div>
