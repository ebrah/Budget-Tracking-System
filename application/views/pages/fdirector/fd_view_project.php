...
<div class="main">
		...
		<p class="text-default" style="letter-spacing: 2px;"> Note: financial director can approve projects and it's budgets. </p>
			...
			<table id="example1" class="table table-bordered table-striped">
                   ...
                   <?php
										...
										<tr>
											...
											<?php 
											       ...
											       if($project->verified == -1){
													...
													: "<td> <span class='label label-danger' style='display:inline-block; margin-bottom: 5px;'> NOT </span> 
													 <a disabled href='".base_url()."public/index.php/hoc/verify/".$project->project_id."' class='btn btn-block btn-warning btn-sm disabled'>verify </a>	</td>" ;
												   }
											...
											if($project->verified == -1){
												echo "<td> <span class='label label-danger' style='display:inline-block; margin-bottom: 5px;'> REJECTED </span> </td>";
												  ...
												  echo $project->approved != '' ? " <td><span class='label label-success'>Approved</span>	</td>": 
												   "<td> <span class='label label-danger' style='display:inline-block; margin-bottom: 5px;'>NOT </span>	
												   <a href='".base_url()."public/index.php/fdirector/approve/".$project->project_id."' class='btn btn-block btn-warning btn-sm '>approve </a>	
												   </td>" ; 
											  }else{
											...
											<td>
											 <?php 
											    if($project->verified != -1 && $project->verified != ''){?>

							                     <button class='btn btn-block btn-danger btn-sm ignor' type="button" data-toggle="modal" data-target="#modal-reject" recommendUrl="<?php echo base_url();?>public/index.php/fdirector/ignore/<?php echo $project->project_id;?>" > reject </button>     	
