  ...
  <div>
      ...
      <div class="col-md-12">
       ...
       <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title"> Editing current description </h3>
              <div class="right">
    ...
    <div class="panel-body">
      <div class="form-horizontal" id="passwordForm">
                ...
                <?php echo form_open_multipart(base_url()."public/index.php/Project/submit_edit");?>
            <div class="row">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" id="inputEmail1" class="form-control regform-control text-white" value="<?php echo $project_id;?>" name="projectId" style="background: #fff; color: #fff; box-shadow: 0 0 #fff; border:0" >
                    <input type="text" id="inputEmail1" class="form-control regform-control text-white" name="projectTitle" >
                </div>
              </div>

              <div class="form-group">
                <label for="inputEmail2" class="col-sm-3 control-label">Project statement </label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-3 control-label">Upload updated project report.</label>
                <div class="col-sm-5">
