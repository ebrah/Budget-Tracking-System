                   ...
                   <?php
										...
										<tr>
											...
											<?php 
											   ...
											   if($project->verified == -1){
													...
													: "<td> <span class='label label-danger' style='display:inline-block; margin-bottom: 5px;'> NOT </span> 
													 <a href='".base_url()."public/index.php/hoc/verify/".$project->project_id."' class='btn btn-block btn-warning btn-sm '>verify </a>	</td>" ;
												   }
											...
											<?php 
										       	...
										       	<?php echo $project->approved != '' ? " <td><span class='label label-success'>Approved</span>	</td>": "<td> <span class='label label-danger'>NOT </span>	</td>" ;
											...
											<td> 
												<button class='btn btn-block btn-default btn-sm' type='button' data-toggle="modal" data-target="#modal-default1"  deleteUrl="<?php echo base_url();?>public/index.php/project/delete_project/<?php echo $project->project_id;?>"  > Delete </button>
											</td>
											...
											<td>
											 <?php 
											    if($project->verified != -1){?>
							                     ...
							                     <button class='btn btn-block btn-danger btn-sm ignor' type="button" data-toggle="modal" data-target="#modal-reject" recommendUrl="<?php echo base_url();?>public/index.php/hoc/ignore/<?php echo $project->project_id;?>" > cancel </button>     	
